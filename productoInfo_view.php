...
<body>
    ...
    <section class="seccion-detalle">
        <div class="container-detalle">
            <div class="product-imagen">
                <div class="producto__logo">
                    <img src="images/hbi-recortado.svg" height="40" alt="">
                </div>
                <img class="producto__imagen" src="./dashboard/uploads/<?php echo $producto['image'] ?>" alt="">
                <div class="dots__imagen">
                    <p></p>
                </div>
            </div>
            ...
            <div class="producto-detalle">
                <div class="header-detalle">
                    <div class="cabecera-detalle">
                        <h1 class="tituloDetalle"><?php echo $producto['nombre'] ?></h1>
                        <img src="icons/pais/<?php echo $producto['iconpais'] ?>.svg">
                    </div>
                    <h2 class="colorCat"><?php echo $producto['subnombre']?></h2>
                </div>
                <div class="infoDetalle proce">
                    <h3>Procedencia: </h3>
                    <p><?php echo $producto['procedencia']?></p>
                </div>
                <div class="infoDetalle fabric">
                    <h3>Fabricante: </h3>
                    <p><?php echo $producto['fabricante']?></p>
                </div>
                <div class="infoDetalle fabric">
                    <h3>Aplicación: </h3>
                    <p> <?php echo $producto['aplicacion']?></p>
                </div>
                <div class="infoDetalle valores">
                    <h3>Valores Adicionales: </h3>
                    <p> <?php echo $producto['valores']?> </p>
                </div>
                <div class="infoDetalle descrip">
                    <h3>Descripcion: </h3>
                    <p><?php echo $producto['descripcion']?></p>
                </div>
                <div class="accordion">
                    <div class="container-acordion">
                        <div class="acordion-lista lista1">Cotizar Producto</div>
                        <div class="contenido-lista">
                            <p>Por favor <span>escoge</span> por que <span>medio </span>quieres <span>contactarte</span>.</p>
                            <div class="opciones-lista">
                                <a href="https://api.whatsapp.com/send?phone=51974609238&text=Hola Hidrobombeo Ingenieros SAC, quisiera información sobre el producto: <?php echo $producto['nombre']?> . Gracias" target="_blank"><i class="fab fa-whatsapp"></i></a>
                                <a href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=informes@hbisac.com.pe&su=Informaci%C3%B3n%20sobre%20producto&body=Hola Hidrobombeo Ingenieros S.A.C., quisiera información sobre el producto <?php echo $producto['nombre']?>. Gracias" target="_blank"><i class="far fa-envelope"></i></a>
                                <!-- https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=informes@hbisac.com.pe -->
                                <a href="https://www.messenger.com/t/241313089327179" target="_blank"><i class="fab fa-facebook-messenger"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- <div class="container-acordion">
                        <div class="acordion-lista lista2">Descargar Manual</div>
                        <div class="contenido-lista descargar">
                            <a href="#"><p>Descargar manual del producto</p></a>
                        </div>
                    </div> -->
                </div>
            </div>
    ...
    <script type="text/javascript">
        VanillaTilt.init(document.querySelector(".producto__imagen"), {
            max: 25,
            speed: 400
        });
        
        //It also supports NodeList
        VanillaTilt.init(document.querySelectorAll(".producto__imagen"));
    </script>

    <script>
        const acordion = document.getElementsByClassName('container-acordion');
